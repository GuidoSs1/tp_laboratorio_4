...
int ll_add(LinkedList* this, void* pElement)
{
    ...
    {
        indice = this->size;
        actual = addNode(this, indice, pElement);
        returnAux = actual;
    }
...
/** \brief Permite tomar un elemento de la lista
 *
 * \param this LinkedList* Puntero a la lista
...
int ll_remove(LinkedList* this,int index)
{
    ...
    if(this != NULL && index >= 0 && index < ll_len(this))
    {
        ...
        if(actual != NULL && prev != NULL && next != NULL)
        {
            if(index == 0)
            {
    ...
    if(this != NULL)
    {
        if(from >= 0 && from <= ll_len(this) && to >= 0 && to <= ll_len(this))
        {
            ...
            for(i=from; i<to; i++)
            {
                ...
                addNode(cloneArray, newSize, pElement);
                newSize++;
            }
        }
    }
...
int ll_sort(LinkedList* this, int (*pFunc)(void*,void*), int order)
{
    ...
    if(this != NULL && pFunc != NULL)
    {
        for(i=0;i<ll_len(this);i++)
        {
            ...
            pAuxElementB = ll_get(this, i+1);

            if((pFunc(pAuxElement, pAuxElementB) < 0 && order == 0) || (pFunc(pAuxElement, pAuxElementB) > 0 && order == 1))
            {
                pAux = pAuxElement;
                ll_set(this, i-1, pAuxElementB);
                ll_set(this, i, pAux);
                returnAux = 0;
            }
        }
